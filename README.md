...
4. Média de renda para cada tipo de canal de venda: Identificar a média de renda dos cliente em diferentes canais de venda pode ajustar a loja a adaptar a estratégia de marketing e vendas para cada público-alvo.
